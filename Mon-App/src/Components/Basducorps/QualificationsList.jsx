    ...
    <section className="section_Bascardio2">
      ...
      <ul className="ul_Bascardio">
        <li className="li_Bascardio">
          ...
          spécifiques en haltérophilie et musculation, pour accompagner des
        ...
        <li className="li_Bascardio">
          ...
          : Une formation universitaire approfondie axée sur la physiologie de
        ...
        <li className="li_Bascardio">
          ...
          récupération, en adaptant l’alimentation et les apports spécifiques
